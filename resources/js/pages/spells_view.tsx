        ...
        <ResourceFormPage
            ...
            fields={[
                ...
                },
                {
                    ...
                    preselected_values: spell?.meta_data?.pc_characters?.map(c => c.id.toString()) ?? [],
                },
                {
                    ...
                    preselected_values: spell?.meta_data?.npc_characters?.map(c => c.id.toString()) ?? [],
                },
                {
                    ...
                    preselected_values: spell?.meta_data?.enemy_characters?.map(c => c.id.toString()) ?? [],
                },
